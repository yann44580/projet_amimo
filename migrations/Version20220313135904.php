 ...
 */
final class Version20220313135904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tools ADD document_tool VARCHAR(255) DEFAULT NULL, ADD tool_content4 LONGTEXT DEFAULT NULL, ADD tool_content5 LONGTEXT DEFAULT NULL');
    }

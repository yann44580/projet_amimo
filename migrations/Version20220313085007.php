 ...
 */
final class Version20220313085007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE associations ADD associations_rgpd LONGTEXT NOT NULL, ADD association_mentions_legales LONGTEXT NOT NULL');
    }
